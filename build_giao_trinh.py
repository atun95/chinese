...
"""
    },
    {
        ...
        <div class="warn-box">
            ...
            • Các vận mẫu bắt đầu bằng <strong>i</strong> sẽ chuyển chữ <strong>i</strong> thành <strong>y</strong> (ia → ya, ian → yan, iang → yang, iong → yong).<br>
            • Các vận mẫu bắt đầu bằng <strong>u</strong> sẽ chuyển chữ <strong>u</strong> thành <strong>w</strong> (uan → wa, uan → wan, uang → wang, uen → wen).<br>
            • Các vận mẫu bắt đầu bằng <strong>ü</strong> sẽ thêm chữ <strong>y</strong> đứng trước và lược bỏ hai dấu chấm trên đầu chữ ü (üan → yuan, ün → yun, üe → yue).
        </div>
...
*   **Quy tắc 1: Khi nguyên âm đứng một mình tạo thành âm tiết độc lập**
    *   Bán nguyên âm **i** biến đổi thành **y** (ian → **yan**, iang → **yang**, iong → **yong**).
    *   Bán nguyên âm **u** biến đổi thành **w** (uan → **wan**, uang → **wang**, uen → **wen**).
    *   Bán nguyên âm **ü** biến đổi thêm **y** và lược dấu chấm (üan → **yuan**, ün → **yun**, üe → **yue**).
...
def build_individual_lessons():
    ...
    css_content = """
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        table, th, td { border: 1px solid var(--border-color); padding: 10px; }
        th { background-color: #f1f5f9; color: var(--primary-color); }
        .info-box { background-color: var(--light-bg); border-left: 5px solid var(--primary-color); padding: 15px; margin: 15px 0; border: 1px solid #cbd5e1; }
        .warn-box { background-color: var(--highlight-bg); border-left: 5px solid #d97706; padding: 15px; margin: 15px 0; border: 1px solid var(--highlight-border); }
        ...
        @media print {
            ...
            .info-box, .warn-box { page-break-inside: avoid; break-inside: avoid; padding: 10px 12px !important; margin: 10px 0 !important; font-size: 12.5px !important; }
            ...
            .exercise-section { margin: 15px 0 !important; padding: 12px !important; page-break-inside: avoid; break-inside: avoid; }
...
<body>
    <div class="container">
        ...
        <div class="cover-page">
            ...
            <h1 class="cover-title">Giáo Trình Phát Âm & Giao Tiếp Tiếng Trung Cơ Bản</h1>
            <div class="cover-subtitle">Phần Lý Thuyết & Bài Tập Thực Hành</div>
        </div>
...
<head>
    ...
    <style>
        {css_content}
        .cover-page {{ height: 95vh; display: flex; flex-direction: column; justify-content: center; align-items: center; border: 4px double var(--primary-color); padding: 40px; background: linear-gradient(135deg, #ffffff 0%, #f0f9ff 100%); margin-top: 2vh; page-break-after: always; }}
    </style>
</head>
<body>
    <div class="container">
