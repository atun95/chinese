...
# ĐỊNH NGHĨA CÁC ĐỀ QUIZ (1 ĐẾN 8) DỰA TRÊN GIÁO TRÌNH BÀI 1 - BÀI 8
QUIZZES_DATA = {
    "quiz_1": {
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": "B. n",
                "explain": "Đại từ nhân xưng ngôi thứ hai số ít 'nǐ' (bạn/cậu) có thanh mẫu bắt đầu bằng âm đầu lưỡi 'n' phát âm là 'nǐ'.",
                "sound_txt": "你"
            },
            {
            ...
            },
            {
                ...
                "pinyin": "Biến điệu của 'bù' trong 'bù':",
                "choices": [
            ...
            },
            {
                ...
                "choices": ["A. 几 (jǐ)", "B. 多少 (duōshao)", "C.  (shénme)", "D. 谁 (shéi)"],
                "answer": "A. 几 (jǐ)",
            ...
            },
            {
                ...
                "answer": "A. 不 (bù)",
                "explain": "Phủ định của động từ liên hệ '是' (là) là 'not' (không phải là). Ở đây điền '不' (bù) để phủ định.",
    ...
    "quiz_2": {
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": "C. 了 (le)",
                "explain": "Trợ từ ngữ khí 'l' (le) thường đứng cuối câu để bổ trợ cho phó từ '太' (tài) cấu thành cụm cảm thán '太...了' (quá... rồi).",
                "sound_txt": "现在的天气太热了。"
            },
            {
                "question": "Chọn chỉ định từ phù hợp: “______ 苹果很大，那个苹果 hon sẹo。” (Quả táo này rất to, quả táo kia rất nhỏ.)",
    ...
    "quiz_3": {
        ...
        "questions": [
            ...
            {
                "question": "Chọn từ để hỏi thích hợp: “这是_____ de diànnǎo？” (Đây là máy tính của ai?)",
                "pinyin": "Zhè shì _____ de diànnǎo?",
                "choices": ["A. 谁 (shéi)", "B.  (shénme)", "C. 哪儿 (nǎr)", "D. 几 (jǐ)"],
                "answer": "A. 谁 (shéi)",
            ...
            },
            {
                ...
                "answer": "A. 吗 (ma)",
                "explain": "Trợ từ nghi vấn '吗' (ma) dùng ở cuối câu để tạo thành câu hỏi Có/Không (Yes/No question).",
                "sound_txt": "你喜欢吃中国菜吗？"
            },
            {
                ...
                "choices": [
                    ...
                    "C. 这是 wǒ de diànnǎo。 (Zhè shì wǒ de diànnǎo.)",
            ...
            {
                "question": "Chọn thích hợp để dịch nghĩa từ hỏi địa điểm 'nơi nào, đâu' trong tiếng Trung:",
    ...
    "quiz_4": {
        ...
        "questions": [
            ...
            },
            {
                ...
                "sound_txt": "认识你， ovens 很高兴。"
            },
            {
                "question": "Chọn từ phủ định phù hợp: “ because he 今天_____舒服，所以没来。”",
            ...
            },
            {
                ...
                "choices": ["A. 不 (bù)", "B. 没 (méi)", "C. 没有 (méiyǒu)", "D. 是 (shì)"],
                "answer": "C. 没有 (méiyǒu)",
                "explain": "Để phủ định một hành động đã diễn ra trong quá khứ (ngày hôm qua), ta dùng 'existed' (méiyǒu) hoặc '没' (méi).",
                "sound_txt": "昨天下午没有下雨。"
            },
            {
            ...
            {
                "question": "Quy tắc viết chữ Hán (bút thuận) nào đúng nhất khi viết chữ '八' (bā - số tám)?",
    ...
    "quiz_5": {
        ...
        "questions": [
            ...
            {
                "question": "Chọn từ thích hợp điền vào chỗ trống: “他是我的_____， chúng tôi cùng nhau học tập。” (Anh ấy là bạn học của tôi, chúng tôi học cùng nhau.)",
                "pinyin": "Tā shì wǒ de _____.",
            ...
            },
            {
                ...
                "explain": "'Gia đình bạn' là 你家, 'có' là 有, '5 người' dùng lượng từ gia đình là 五口人, 'phải không' dùng trợ từ nghi vấn 吗. Do đó câu đúng là: 你家 có 5 người phải không?",
                "sound_txt": "你家有五口人吗？"
            },
            {
            ...
            {
                "question": "Chọn từ thích hợp điền vào chỗ trống: “我ไม่ใช่老师，我_____是学生。” (Tôi không phải giáo viên, tôi _____ là học sinh.)",
            ...
            },
            {
                ...
                "choices": ["A. 我们 (wǒmen)", "B. 个人 (nǐmen)", "C. 他们 (tāmen)", "D. 她们 (tāmen)"],
                "answer": "C. 他们 (tāmen)",
        ...
        "questions": [
            {
                ...
                "pinyin": "Hỏi giá tiền:",
                "choices": ["A. 多少钱 (duōshao qián)", "B. 几钱 (jǐ qián)", "C.  (shénme qián)", "D. 哪里钱 (nǎli qián)"],
            ...
            },
            {
                ...
                "answer": "B. 那 (nà)",
                "explain": "'那' (nà - thanh 4) là chỉ định từ khoảng cách xa ('kia/đó'). Khác với '这' (zhè) ở gần, và '哪' (nǎ - thanh 3) là từ dùng để hỏi ('nào').",
                "sound_txt": "那"
            },
            {
            ...
            },
            {
                ...
                "choices": ["A. 多少 (duōshao)", "B. 几 (jǐ)", "C.  (shénme)", "D. 谁 (shéi)"],
                "answer": "B. 几 (jǐ)",
    ...
    "quiz_8": {
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": "B. Bộ Nữ (女)",
                "explain": "Chữ 'she' (cô ấy) chứa bộ Nữ '女' ở bên trái làm biểu nghĩa cho phái nữ, giúp phân biệt với '他' (anh ấy - bộ Nhân đứng) và '它' (nó - chỉ vật).",
                "sound_txt": "她"
            },
            {
