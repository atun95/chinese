...
B7_1_QUESTION_WORDS_DATA = [
    {
        "nhom": "1. Hỏi về Người và Vật",
        "mota": "Các từ dùng để hỏi về danh tính người hoặc sự vật, sự việc.",
        "items": [
            {
                "tu": "谁",
                "pinyin": "shéi / shuí",
    ...
    {
        "nhom": "2. Hỏi về Địa điểm và Nơi chốn",
        "mota": "Các từ để hỏi về vị trí, địa điểm, nơi chốn.",
        "items": [
            {
                "tu": "哪",
                "pinyin": "nǎ",
    ...
    {
        "nhom": "3. Hỏi về Số lượng",
        "mota": "Các từ để hỏi về số lượng, giá cả, tuổi tác.",
        "items": [
            {
                "tu": "几",
                "pinyin": "jǐ",
    ...
    {
        "nhom": "4. Hỏi về Phương thức và Trạng thái",
        "mota": "Các từ để hỏi về cách thức thực hiện và tình trạng sự vật.",
        "items": [
            {
                "tu": "怎么",
                "pinyin": "zěnme",
    ...
    {
        "nhom": "5. Trợ từ nghi vấn cuối câu",
        "mota": "Các trợ từ dùng cuối câu để biến câu trần thuật thành câu hỏi.",
        "items": [
            {
                "tu": "吗",
                "pinyin": "ma",
        ...
        "items": [
            {
                ...
                "cautrucs": [
                    {
                        "ct": "S + 什么时候 + V + O？ (Hỏi thời điểm ai đó làm gì)",
                        "vd_han": "你什么时候去中国？",
            ...
            },
            {
                ...
                "cachdung": "Hỏi lý do, nguyên nhân của hành động, sự việc.",
                "cautrucs": [
                    {
                        "ct": "S + 为什么 + V + O？ (Hỏi lý do tại sao ai đó làm gì)",
                        "vd_han": "你为什么不喝茶？",
...
B7_1_QUIZ_DATA = [
    {
        "q": "Chọn từ hỏi phù hợp: '___ là anh ấy?' (để hỏi danh tính)",
        "choices": ["那个是谁？ (Nàge shì shéi?)", "那个是什么？ (Nàge shì shénme?)", "那个是哪儿？ (Nàge shì nǎr?)"],
        "answer": "那个是谁？ (Nàge shì shéi?)",
        "explain": "谁 (shéi) dùng để hỏi về danh tính của người."
    },
    {
        "q": "Chọn câu đúng: 'Đây là quyển sách gì?'",
        "choices": ["这是什么书？ (Zhè shì shénme shū?)", "这是几书？ (Zhè shì jǐ shū?)", "这是谁书？ (Zhè shì shéi shū?)"],
        "answer": "这是什么书？ (Zhè shì shénme shū?)",
        "explain": "什么 + N dùng để hỏi về tên gọi, loại vật."
    },
    {
        "q": "Câu 'Nhà bạn có mấy người?' dùng từ hỏi nào?",
        "choices": ["几 (jǐ)", "多少 (duōshao)", "怎么 (zěnme)"],
        "answer": "几 (jǐ)",
        "explain": "几 dùng hỏi số lượng nhỏ, bắt buộc có lượng từ (几口人)."
    },
    {
        "q": "'Cái cốc này bao nhiêu tiền?' dùng từ hỏi nào?",
        "choices": ["几 (jǐ)", "多少 (duōshao)", "谁 (shéi)"],
        "answer": "多少 (duōshao)",
        "explain": "多少钱 là cụm cố định để hỏi giá cả."
    },
    {
        "q": "'Chữ này viết thế nào?' dùng từ hỏi nào?",
        "choices": ["怎么 (zěnme)", "怎么样 (zěnmeyàng)", "什么 (shénme)"],
        "answer": "怎么 (zěnme)",
        "explain": "怎么 + V để hỏi cách thức. 怎么写 = viết thế nào."
    },
    {
        "q": "'Thời tiết hôm nay thế nào?' dùng từ hỏi nào?",
        "choices": ["怎么 (zěnme)", "怎么样 (zěnmeyàng)", "吗 (ma)"],
        "answer": "怎么样 (zěnmeyàng)",
        "explain": "怎么样 dùng cuối câu hỏi tình trạng, tính chất."
    },
    {
        "q": "Câu 'Tôi thích ăn bánh ú, còn bạn?' dùng trợ từ cuối nào?",
        "choices": ["我喜欢吃粽子，你呢？ (Wǒ xǐhuan chī zòngzi, nǐ ne?)", "我喜欢吃粽子，你吗？ (Wǒ xǐhuan chī zòngzi, nǐ ma?)", "我喜欢吃粽子，你是谁？ (Wǒ xǐhuan chī zòngzi, nǐ shì shéi?)"],
        "answer": "我喜欢吃粽子，你呢？ (Wǒ xǐhuan chī zòngzi, nǐ ne?)",
        "explain": "呢 dùng để hỏi tỉnh lược 'còn bạn thì sao?'"
    },
    {
        "q": "Khi nhận được lời khen, câu phản hồi khiêm tốn nào đúng?",
        "choices": ["哪儿，哪儿！ (Nǎr, nǎr!)", "哪里，哪里！ (Nǎlǐ, nǎlǐ!)", "不客气！ (Bú kèqi!)"],
        "answer": "哪里，哪里！ (Nǎlǐ, nǎlǐ!)",
        "explain": "哪里，哪里 là cách phản hồi khiêm tốn khi nhận lời khen. Không dùng 哪儿，哪儿 cho mục đích này."
    },
    {
        "q": "'Sao bạn không ăn bánh ú?' dùng câu nào đúng?",
    ...
    },
    {
        ...
        "choices": ["你为什么不喝茶？ (Nǐ wèishénme bù hē chá?)", "你什么时候喝茶？ (Nǐ shénme shíhou hē chá?)", "Ref: 你喝茶吗？ (Nǐ hē chá ma?)", "你喝茶吗？ (Nǐ hē chá ma?)"],
        "choices": ["你为什么不喝茶？ (Nǐ wèishénme bù hē chá?)", "你什么时候喝茶？ (Nǐ shénme shíhou hē chá?)", "你喝茶吗？ (Nǐ hē chá ma?)"],
        "answer": "Ref: 你为什么不喝茶？ (Nǐ wèishénme bù hē chá?)",
...
B7_2_DE_DATA = [
        ...
        "items": [
            {
                "tu": "我的书",
                "pinyin": "wǒ de shū",
                "nghianhanh": "Sách của tôi",
                "cachdung": "Đại từ '我' sở hữu danh từ '书'. Bắt buộc dùng 'de' vì '书' là đồ vật cá nhân.",
                "vd_han": "这是我的书。",
                "vd_py": "Zhè shì wǒ de shū.",
                "vd_vi": "Đây là cuốn sách của tôi.",
                "sound_txt": "这是我的书。"
            },
            {
                "tu": "老师的电脑",
                "pinyin": "lǎoshī de diànnǎo",
                "nghianhanh": "Máy tính của thầy giáo",
                "cachdung": "Danh từ '老师' sở hữu danh từ '电脑'. Bắt buộc dùng 'de' vì máy tính là tài sản.",
                "vd_han": "老师的电脑在桌子上。",
                "vd_py": "Lǎoshī de diànnǎo zài zhuōzi shang.",
                "vd_vi": "Máy tính của thầy giáo ở trên bàn.",
                "sound_txt": "老师的电脑在桌子上。"
            }
        ]
    },
    {
        ...
        "items": [
            {
                "tu": "很好的朋友",
                "pinyin": "hěn hǎo de péngyou",
                "nghianhanh": "Người bạn rất tốt",
                "cachdung": "Cụm tính từ '很好' bổ nghĩa cho danh từ '朋友'.",
                "vd_han": "他是我的很好的朋友。",
                "vd_py": "Tā shì wǒ de hěn hǎo de péngyou.",
                "vd_vi": "Anh ấy là người bạn rất tốt của tôi.",
                "sound_txt": "他是我的很好的朋友。"
            },
            {
                "tu": "很大的苹果",
                "pinyin": "hěn dà de píngguǒ",
                "nghianhanh": "Quả táo rất to",
                "cachdung": "Cụm tính từ '很大' bổ nghĩa cho danh từ '苹果'.",
                "vd_han": "我要买很大的苹果。",
                "vd_py": "Wǒ yào mǎi hěn dà de píngguǒ.",
                "vd_vi": "Tôi muốn mua quả táo rất to.",
                "sound_txt": "我要买很大的苹果。"
            }
        ]
    },
        ...
        "items": [
            {
                "tu": "大的",
                "pinyin": "dà de",
                "nghianhanh": "Cái to / Quả to",
                "cachdung": "Rút gọn khi ngữ cảnh đã rõ ràng.",
                "vd_han": "你要哪个苹果？我要大的。",
...
B7_2_QUIZ_DATA = [
    {
        "q": "Chọn câu dịch đúng nhất: 'Máy tính của bố tôi ở trên bàn.'",
        "choices": ["我爸爸的电脑在桌子上。 (Wǒ bàba de diànnǎo zài zhuōzi shang.)", "我的爸爸电脑在桌子上。 (Wǒ de bàba diànnǎo zài zhuōzi shang.)", "我爸爸电脑在桌子上。 (Wǒ bàba diànnǎo zài zhuōzi shang.)"],
        "answer": "我爸爸的电脑在桌子上。 (Wǒ bàba de diànnǎo zài zhuōzi shang.)",
        "explain": "'Bố tôi' là người thân, bỏ 的 thành '我爸爸'. 'Máy tính' là tài sản, bắt buộc giữ 的 thành '我爸爸的电脑'."
    },
    {
        "q": "Trong câu nào có thể lược bỏ chữ 的 mà câu vẫn tự nhiên?",
        "choices": ["这是我的电脑。 (Zhè shì wǒ de diànnǎo.)", "他是我的老师。 (Tā shì wǒ de lǎoshī.)", "这是我的书。 (Zhè shì wǒ de shū.)"],
        "answer": "他是我的老师。 (Tā shì wǒ de lǎoshī.)",
        "explain": "'老师' chỉ mối quan hệ xã hội quen thuộc, có thể bỏ 的 thành '他是我老师'."
    },
    {
        "q": "Điền từ thích hợp: '这是我们___学校。'",
        "choices": ["的 (de)", "hoặc để trống (không cần điền)", "Cả hai phương án trên đều đúng"],
        "answer": "Cả hai phương án trên đều đúng",
        "explain": "Với nơi chốn, cơ quan gắn liền ('学校'), có thể giữ 'de' hoặc lược bỏ đều đúng."
    },
    {
        "q": "Chọn câu sai ngữ pháp:",
        "choices": ["他是我的朋友。 (Tā shì wǒ de péngyou.)", "这是我书。 (Zhè shì wǒ shū.)", "我妈妈在医院工作。 (Wǒ māma zài yīyuàn gōngzuò.)"],
        "answer": "这是我书。 (Zhè shì wǒ shū.)",
        "explain": "Đồ vật cá nhân (书) bắt buộc phải dùng 'de'. Phải nói '这是我的书'."
    },
    {
        "q": "Chọn cách nói tự nhiên nhất: 'Mẹ của con trai anh ấy'",
        "choices": ["他儿子的妈妈 (Tā érzi de māma)", "他的儿子的妈妈 (Tā de érzi de māma)", "他儿子妈妈 (Tā érzi māma)"],
        "answer": "他儿子的妈妈 (Tā érzi de māma)",
        "explain": "Lược bỏ 的 ở tầng đầu ('他儿子') và giữ 的 ở tầng cuối để câu rõ ràng."
    },
    {
        "q": "Trong cụm '很好的朋友', '很好的' đóng vai trò ngữ pháp gì?",
        "choices": ["Định ngữ bổ nghĩa cho danh từ '朋友'", "Trạng ngữ bổ nghĩa cho động từ", "Bổ ngữ kết quả"],
        "answer": "Định ngữ bổ nghĩa cho danh từ '朋友'",
        "explain": "Tính từ + 的 đứng trước danh từ làm định ngữ mô tả tính chất của danh từ đó."
    },
    {
        "q": "Điền vào chỗ trống: '你要买大杯子还是小___？'",
        "choices": ["的 (de)", "吗 (ma)", "呢 (ne)"],
        "answer": "的 (de)",
        "explain": "Cấu trúc chữ '的' lược bỏ '杯子' đã đề cập: '小的' = cốc nhỏ."
    },
    {
        "q": "Chọn câu dịch đúng: 'Cái cốc màu đỏ này là của tôi.'",
        "choices": ["这个红色的杯子是我的。 (Zhège hóngsè de bēizi shì wǒ de.)", "这个红色杯子是我。 (Zhège hóngsè bēizi shì wǒ.)", "这个红色的杯子是我书。 (Zhège hóngsè de bēizi shì wǒ shū.)"],
        "answer": "这个红色的杯子是我的。 (Zhège hóngsè de bēizi shì wǒ de.)",
        "explain": "'Màu đỏ' dùng '红色的杯子'. 'Của tôi' dùng cấu trúc chữ 的 thay cho '我的杯子' → '是我的'."
    },
    {
        "q": "Tính từ đơn âm (大, 小, 好) nối trực tiếp với danh từ có cần 'de' không?",
        "choices": ["Bắt buộc dùng 'de'", "Không cần dùng 'de' (Ví dụ: 大苹果, 好人)", "Không được phép kết hợp trực tiếp"],
        "answer": "Không cần dùng 'de' (Ví dụ: 大苹果, 好人)",
        "explain": "Tính từ đơn âm tiết có thể ghép trực tiếp với danh từ không cần 'de'."
    },
    {
        "q": "Chọn câu đúng ngữ pháp nhất:",
        "choices": ["这本书是他的。 (Zhè běn shū shì tā de.)", "这本书是他。 (Zhè běn shū shì tā.)", "这本书是他书。 (Zhè běn shū shì tā shū.)"],
        "answer": "这本书是他的。 (Zhè běn shū shì tā de.)",
