...
<i>Ví dụ:</i> <b>我还没饱。</b> (Wǒ hái méi bǎo.) — <i>Tôi vẫn chưa no.</i>
        ...
        with col_ex2:
            render_play_button("我们已经十八岁了", "🔊 weimen yijing shiba sui le", key="play_ex_yijing_2")


def show_lesson5_duanwu():
    render_lesson_intro(
        title="Bài 5.4 - Lễ hội Đoan Ngọ (端午节)",
...
Thương tiếc ông, người dân hối hả chèo thuyền ra cứu (nguồn gốc của <b>đua thuyền rồng</b>), đồng thời ném cơm nếp bọc lá tre xuống sông để cá không ăn thân xác ông (nguồn gốc của <b>bánh tro - bánh ú</b>). Từ đó, ngày 5/5 âm lịch trở thành ngày Tết Đoan Ngọ để tưởng nhớ ông.
    ...
    with tab_vocab:
        DW_VOCAB = [
            ...
            {
                "emoji": "🍷", "word": "雄黄酒", "pinyin": "xiónghuáng jiǔ", "vietnamese": "Rượu hùng hoàng", "key_prefix": "b5_dw_xionghuangjiu",
                "example_han": "喝雄黄酒是传统习俗。", "example_py": "Hē xiónghuáng jiǔ shì chuántǒng xísú.", "example_vi": "Uống rượu hùng hoàng là phong tục truyền thống.",
                "story": "Loại rượu pha bột hùng hoàng để trừ độc, xua đuổi rắn rết. (Y học hiện đại khuyến cáo không nên uống vì chứa thạch tín)."
            },
            {
            ...
            {
                "emoji": "🏛️", "word": "传统", "pinyin": "chuántǒng", "vietnamese": "Truyền thống", "key_prefix": "b5_dw_chuantong",
                "example_han": "这是传统文化。", "example_py": "Zhè shì chuántǒng wénhuà.", "example_vi": "Đây là văn hóa truyền thống.",
                "story": "Các tập tục, giá trị tốt đẹp được truyền nối qua các thế hệ lịch sử lâu đời."
            },
            {
                "emoji": "🎗️", "word": "纪念", "pinyin": "jìniàn", "vietnamese": "Tưởng nhớ", "key_prefix": "b5_dw_jinian",
                "example_han": "纪念伟大的诗人。", "example_py": "Jìniàn wěidà de shīrén.", "example_vi": "Tưởng nhớ nhà thơ vĩ đại.",
                "story": "Hành động ghi nhớ công ơn, giữ gìn hình ảnh tốt đẹp của người xưa."
            }
        ]
...
Người dân bện ngải cứu và xương bồ treo trước cửa phòng tránh muỗi rừng và độc trùng mang mầm mống ôn dịch mùa hè.
</div>
<div style="background-color: #f8fafc; border-left: 4px solid #059669; padding: 15px; border-radius: 8px; margin-bottom: 12px;">
...
<td style="padding: 12px;">Khảo cây, ăn quả chua, rượu nếp sáng sớm diệt côn trùng</td>
    ...
    with tab_phrases:
        st.markdown("""
<div style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-left: 6px solid #10b981; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
<h4 style="color: #14532d; margin-top: 0; font-weight: bold;">💡 Góc Văn Hóa: Tại sao chúc "Đoan Ngọ An Khang" (端午安康)?</h4>
<p style="color: #166534; line-height: 1.6; margin-bottom: 0;">
Nhiều người quan niệm ngày này gắn liền với cái chết thương tâm của Khuất Nguyên và sự bùng phát ôn dịch mùa hè. Do đó chúc <b>快乐 (kuàilè - Vui vẻ)</b> đôi khi bị cho là chưa phù hợp. Thay vào đó, lời chúc ý nghĩa nhất là <b>安康 (ānkāng - Bình an và Khỏe mạnh)</b> để cầu mong sự an lành, tai qua nạn khỏi.
        ...
        with col_g1:
            st.markdown("### 💬 Lời chúc Đoan Ngọ:")
            st.info("**端午安康！** (Duānwǔ ānkāng!) — Đoan Ngọ an khang!")
            render_play_button("端午安康", "🔊 Nghe chúc: 端午安康", key="dw_p1")
            st.write("")
            st.info("**端午节快乐！** (Duānwǔ Jié kuàilè!) — Tết Đoan Ngọ vui vẻ!")
            render_play_button("端午节快乐", "🔊 Nghe chúc: 端午节快乐", key="dw_p2")
        with col_g2:
            st.markdown("### 🗣️ Giao tiếp mẫu:")
            st.success("**你吃粽子了吗？** (Nǐ chī zòngzi le ma?) — Bạn ăn bánh tro chưa?")
            render_play_button("你吃粽子了吗？", "🔊 Nghe mẫu", key="dw_p3")
            st.write("")
